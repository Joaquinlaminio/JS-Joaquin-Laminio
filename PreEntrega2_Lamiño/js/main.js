...
//mi array
const datosProveedores =  [proveedor1, proveedor2, proveedor3, proveedor4, proveedor5];
console.log(datosProveedores);

console.log(datosProveedores.length);
for (let index =0; index < Array.length; index++) {
    const element = Array[index];
}

const fragmento = datosProveedores.splice (4,5);
